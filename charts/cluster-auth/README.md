...
$ helm repo update
$ helm search repo appscode/cluster-auth-agent --version=v2024.7.10
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2024.7.10
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2024.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2024.7.10 --values values.yaml
```
