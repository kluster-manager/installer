...
$ helm repo update
$ helm search repo appscode/cluster-manager-hub --version=v2025.4.30
$ helm upgrade -i cluster-manager-hub appscode/cluster-manager-hub -n open-cluster-management --create-namespace --version=v2025.4.30
```
...
```bash
$ helm upgrade -i cluster-manager-hub appscode/cluster-manager-hub -n open-cluster-management --create-namespace --version=v2025.4.30 --set hub.registry=quay.io/open-cluster-management
```
...
```bash
$ helm upgrade -i cluster-manager-hub appscode/cluster-manager-hub -n open-cluster-management --create-namespace --version=v2025.4.30 --values values.yaml
```
