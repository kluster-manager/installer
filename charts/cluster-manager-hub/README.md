...
$ helm repo update
$ helm search repo appscode/cluster-manager-hub --version=v2026.2.16
$ helm upgrade -i cluster-manager-hub appscode/cluster-manager-hub -n open-cluster-management --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i cluster-manager-hub appscode/cluster-manager-hub -n open-cluster-management --create-namespace --version=v2026.2.16 --values values.yaml
```
