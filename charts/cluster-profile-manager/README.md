...
$ helm repo update
$ helm search repo appscode/cluster-profile-manager --version=v2026.6.26
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.6.26
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.6.26 --set manager.image=ghcr.io/kluster-manager/cluster-profile
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.6.26 --values values.yaml
```
