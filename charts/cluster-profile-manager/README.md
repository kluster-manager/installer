...
$ helm repo update
$ helm search repo appscode/cluster-profile-manager --version=v2026.9.18
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.9.18
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.9.18 --set manager.image=ghcr.io/kluster-manager/cluster-profile
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2026.9.18 --values values.yaml
```
