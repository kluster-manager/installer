...
$ helm repo update
$ helm search repo appscode/cluster-profile-manager --version=v2024.9.24
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2024.9.24
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2024.9.24 --set manager.image=ghcr.io/kluster-manager/cluster-profile
```
...
```bash
$ helm upgrade -i cluster-profile-manager appscode/cluster-profile-manager -n open-cluster-management-addon --create-namespace --version=v2024.9.24 --values values.yaml
```
