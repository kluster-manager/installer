...
$ helm repo update
$ helm search repo appscode/spoke-cluster-addons --version=v2026.2.16
$ helm upgrade -i spoke-cluster-addons appscode/spoke-cluster-addons -n c1 --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i spoke-cluster-addons appscode/spoke-cluster-addons -n c1 --create-namespace --version=v2026.2.16 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i spoke-cluster-addons appscode/spoke-cluster-addons -n c1 --create-namespace --version=v2026.2.16 --values values.yaml
```
