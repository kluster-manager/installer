...
$ helm repo update
$ helm search repo appscode/cluster-manager-spoke --version=v2026.2.16
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2026.2.16 --set clusterMetadata.name=TBD
```
...
```bash
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2026.2.16 --values values.yaml
```
