...
$ helm repo update
$ helm search repo appscode/cluster-manager-spoke --version=v2025.7.31
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2025.7.31 --set clusterMetadata.name=TBD
```
...
```bash
$ helm upgrade -i cluster-manager-spoke appscode/cluster-manager-spoke -n open-cluster-management --create-namespace --version=v2025.7.31 --values values.yaml
```
