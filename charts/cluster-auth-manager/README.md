...
$ helm repo update
$ helm search repo appscode/cluster-auth-manager --version=v2026.2.16
$ helm upgrade -i cluster-auth-manager appscode/cluster-auth-manager -n open-cluster-management-addon --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i cluster-auth-manager appscode/cluster-auth-manager -n open-cluster-management-addon --create-namespace --version=v2026.2.16 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i cluster-auth-manager appscode/cluster-auth-manager -n open-cluster-management-addon --create-namespace --version=v2026.2.16 --values values.yaml
```
