...
KLUSTER_MANAGER_CLUSTER_AUTH_TAG=${KLUSTER_MANAGER_CLUSTER_AUTH_TAG:-v0.5.0}
KLUSTER_MANAGER_CLUSTER_PROFILE_TAG=${KLUSTER_MANAGER_CLUSTER_PROFILE_TAG:-v0.11.0}
KLUSTER_MANAGER_FLUXCD_ADDON_TAG=${KLUSTER_MANAGER_FLUXCD_ADDON_TAG:-v0.0.10}
KUBESLICE_APIS_TAG=${KUBESLICE_APIS_TAG:-release-v2026.1.15}
...
crd-importer \
    ...
    --input=https://github.com/kube-slice/apis/raw/${KUBESLICE_APIS_TAG}/crd/controller.kubeslice.io_clusters.yaml \
    --out=./charts/spoke-cluster-addons/crds
